        ...
        <?php
            if ( is_category() ) {
                ...
                */
                ...
                printf( __( 'Daily Archives: %s', 'calvero' ), '<span>' . get_the_date() . '</span>' );
 
            } elseif ( is_month() ) {
                printf( __( 'Monthly Archives: %s', 'calvero' ), '<span>' . get_the_date( 'F Y' ) . '</span>' );
 
            } elseif ( is_year() ) {
                printf( __( 'Yearly Archives: %s', 'calvero' ), '<span>' . get_the_date( 'Y' ) . '</span>' );
